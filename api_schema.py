...
class AuthMobileCodeResponseDatadata_(object):
...
class AuthMobileCodeResponseDatadata_Schema(marshmallow.Schema):
    ...
    def make_object(self, data, original_data):
        data['original_data'] = original_data
        obj = AuthMobileCodeResponseDatadata_(**data)
        return obj


class AuthMobileLoginRequestchild_info_(object):
...
class AuthMobileLoginRequestchild_info_Schema(marshmallow.Schema):
    ...
    def make_object(self, data, original_data):
        data['original_data'] = original_data
        obj = AuthMobileLoginRequestchild_info_(**data)
        return obj


class OrderCancelResponsedata_(object):
...
class OrderCancelResponsedata_Schema(marshmallow.Schema):
    order_id = marshmallow.fields.String(validate=validator.v_enc_id)  # 取消订单 idexample: uuid_order_1

    @marshmallow.post_load(pass_original=True)
    def make_object(self, data, original_data):
        data['original_data'] = original_data
        obj = OrderCancelResponsedata_(**data)
        return obj


class OrderPayResponsedata_(object):
...
class OrderPayResponsedata_Schema(marshmallow.Schema):
    ...
    def make_object(self, data, original_data):
        data['original_data'] = original_data
        obj = OrderPayResponsedata_(**data)
        return obj


class OrderSubmitRequestchildren_(object):
...
class OrderSubmitRequestchildren_Schema(marshmallow.Schema):
    ...
    def make_object(self, data, original_data):
        data['original_data'] = original_data
        obj = OrderSubmitRequestchildren_(**data)
        return obj


class OrderSubmitResponsedata_(object):
...
class OrderSubmitResponsedata_Schema(marshmallow.Schema):
    order_ids = marshmallow.fields.List(marshmallow.fields.String(validate=validator.v_enc_id))
    ...
    def make_object(self, data, original_data):
        data['original_data'] = original_data
        obj = OrderSubmitResponsedata_(**data)
        return obj
...
class CarerApplyRequestDatavideo_(object):
...
class CarerApplyRequestDatavideo_Schema(marshmallow.Schema):
    ...
    def make_object(self, data, original_data):
        data['original_data'] = original_data
        obj = CarerApplyRequestDatavideo_(**data)
        return obj
...
class AuthMobileCodeResponseDataSchema(marshmallow.Schema):
    ...
    data = marshmallow.fields.Nested(AuthMobileCodeResponseDatadata_Schema())
...
class AuthMobileLoginRequestSchema(marshmallow.Schema):
    ...
    child_info = marshmallow.fields.Nested(AuthMobileLoginRequestchild_info_Schema())
...
class OrderCancelResponseSchema(marshmallow.Schema):
    status = marshmallow.fields.Nested(StatusSchema(), required=True)
    data = marshmallow.fields.Nested(OrderCancelResponsedata_Schema(), required=True)
...
class OrderPayResponseSchema(marshmallow.Schema):
    status = marshmallow.fields.Nested(StatusSchema(), required=True)
    data = marshmallow.fields.Nested(OrderPayResponsedata_Schema(), required=True)
...
class OrderSubmitRequestSchema(marshmallow.Schema):
    ...
    children = marshmallow.fields.List(marshmallow.fields.Nested(OrderSubmitRequestchildren_Schema()), required=True)
...
class OrderSubmitResponseSchema(marshmallow.Schema):
    status = marshmallow.fields.Nested(StatusSchema(), required=True)
    data = marshmallow.fields.Nested(OrderSubmitResponsedata_Schema(), required=True)
...
class CarerApplyRequestDataSchema(marshmallow.Schema):
    video = marshmallow.fields.Nested(CarerApplyRequestDatavideo_Schema(), required=True)
